...
def login():
    s = requests.session()
    um = ['anne','Abbyabbie','abigale','SEAN','William','Vincent','Bill','Mark','Charle.','WARREN','TERRY','OSCAR','KEN','Joseph','James','Henry','Gary','Martin','Clifford','Cliff','zoey','tracy','sharon','rachel','nicole','milly','larein','joy','gladys','ella','kri','carina','aviva','angela','amber']
    username = um[random.randint(0,34)]
    try:
